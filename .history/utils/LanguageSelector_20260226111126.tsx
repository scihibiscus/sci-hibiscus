...
const LanguageSelector = ({
  ...
  const updatePathnameLocalePrefix = (newLocale: string) => {
    ...
    // Check if the current page is 'en plannifcation' or 'in planning'
    if (newPathname.includes("/services/a-louer") || newPathname.includes("/services/for-rent")) {
      // Adjust the pathname based on the new locale
      newPathname =
        newLocale === "fr"
          ? newPathname.replace("/services/for-rent", "/services/a-louer")
          : newPathname.replace("/services/a-louer", "/services/for-rent");
    }

    // Check if the current page is 'en plannifcation' or 'in planning'
    if (newPathname.includes("/services/a-vendre") || newPathname.includes("/services/for-sale")) {
      // Adjust the pathname based on the new locale
      newPathname =
        newLocale === "fr"
          ? newPathname.replace("/services/for-sale", "/services/a-vendre")
          : newPathname.replace("/services/a-vendre", "/services/for-sale");
    }
