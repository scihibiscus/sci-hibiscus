...
/**
 * Props
 * - text: string — phrase ou paragraphe complet
 * - words: string[] — mots à styliser (exact match, insensible à la casse)
 * - className: string — classe CSS à appliquer aux mots ciblés (défaut "highlight")
 */
