...
const LanguageSelector = ({
  ...
  const updatePathnameLocalePrefix = (newLocale: string) => {
    ...
    // Check if the current page is 'en plannifcation' or 'in planning'
    if (newPathname.includes("/services/a-louer") || newPathname.includes("/career")) {
      // Adjust the pathname based on the new locale
      newPathname =
        newLocale === "fr"
          ? newPathname.replace("/career", "/services/a-louer")
          : newPathname.replace("/services/a-louer", "/career");
    }
