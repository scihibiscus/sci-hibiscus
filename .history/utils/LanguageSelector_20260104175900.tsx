...
const LanguageSelector = ({
  ...
  const updatePathnameLocalePrefix = (newLocale: string) => {
    ...
    if (newPathname.includes("/projets/projets-actuels") || newPathname.includes("/projects/current-projects")) {
      // Adjust the pathname based on the new locale
      newPathname =
        newLocale === "fr"
          ? newPathname.replace("/projects/current-projects", "/projets/projets-actuels")
          : newPathname.replace("/projets/projets-actuels", "/projects/current-projects");
    }
