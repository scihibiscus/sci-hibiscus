...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: t("HomePage:metadesc"),
...
/**Translations */
const i18nNamespaces = ["Navigation", "HomePage", "ProjectsPage", "BuylandPage", "BlogPage", "ServicesPage", "PrivacyPage", "AboutPage", "CareerPage", "ContactPage"];
