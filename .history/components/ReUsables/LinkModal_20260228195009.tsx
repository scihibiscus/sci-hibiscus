...
import Grid from "@/utils/Icons/Grid";
import Briefcase from "@/utils/Icons/Briefcase";
import Map from "@/utils/Icons/Map";
import Building from "@/utils/Icons/Building";
        ...
        <div className={styles.lm__wrapper}>
          <div className={styles.lm__modal}>
            ...
            <div className={styles.lmm__content}>
              ...
              <Link
                href={currentLocale === "en" ? "/en/services/for-rent" : "/fr/services/a-louer"}
              ...
              <Link
                href={currentLocale === "en" ? "/en/services/for-sale" : "/fr/services/a-vendre"}
                className={styles.lmm}
              >
                <div>
                  <Briefcase />
