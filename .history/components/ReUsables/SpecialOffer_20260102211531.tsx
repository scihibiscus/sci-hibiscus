  ...
  const offers = [
    {
      ...
      link:
        currentLocale === "en"
          ? "/en/projects/current-projects/hibiscus-residence"
          : "/fr/projets/projets-actuels/hibiscus-residence",
    },
    {
      name: "Amos Residence",
      link:
        currentLocale === "en"
          ? "/en/projects/current-projects/amos-residence"
          : "/fr/projets/projets-actuels/amos-residence",
    },
    {
      name: "Pure Residence",
      link:
        currentLocale === "en"
          ? "/en/projects/current-projects/pure-residence"
          : "/fr/projets/projets-actuels/pure-residence",
    },
    {
      name: "Luxe Residence",
      link:
        currentLocale === "en"
          ? "/en/projects/current-projects/luxe-residence"
          : "/fr/projets/projets-actuels/luxe-residence",
    },
    {
      name: "Habi Residence",
      link:
        currentLocale === "en"
          ? "/en/projects/current-projects/habi-residence"
          : "/fr/projets/projets-actuels/habi-residence",
    },
  ];
