      ...
      <div className={`container ${styles.reuse__container}`}>
        ...
        <div className={styles.rc__bottom}>
          ...
          <p className={styles.rcb__right}>
            ...
            développement de propriétés durables et habitables. Nous créons des
            espaces sur mesure pour différents modes de vie et concevons des
            biens avec une valeur patrimoniale durable. Que ce soit pour votre
            usage personnel ou pour investissement – laissez-vous inspirer par
            notre offre immobilière et profitez des avantages d'acheter
