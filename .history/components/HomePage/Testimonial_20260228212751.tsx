      ...
      <div className={`container ${styles.testi__container}`}>
        ...
        <div className={styles.testi__bottom}>
          <div className={styles.testi__card}>
            ...
            <p className={styles.tc__p}>
              Living at Concept Bonapriso has been a wonderful experience. The
              design feels modern yet welcoming, and it truly provides a
              comfortable, inspiring place to call home.
            </p>
