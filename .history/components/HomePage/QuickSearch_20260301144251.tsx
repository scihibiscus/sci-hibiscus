...
/** Types */ type FilterOption = { name: string; value: string; }; type QuickCategory = { id: number; category: string; question: string; paramKey: string; filters: FilterOption[]; }; type Selections = Record<number, string[]>;
};
