...
const Testimonial = () => {
  ...
  const testimonialsData = [
    ...
    },
    {
      ...
      projectlink:
        currentLocale === "en"
          ? "/en/projects/references?ref=concept-bonaprisoo"
          : "/fr/projets/references?ref=concept-bonaprisoo",
    },
    {
      image: IMAGE,
      name: "Amelia Doe",
      ...
      projectlink:
        currentLocale === "en"
          ? "/en/projects/references?ref=concept-bonaprisooo"
          : "/fr/projets/references?ref=concept-bonaprisooo",
    },
    {
      name: "John Doe",
      projectname: "Concept Bonapriso",
      ...
      projectlink:
        currentLocale === "en"
          ? "/en/projects/references?ref=concept-bonaprisoooo"
          : "/fr/projets/references?ref=concept-bonaprisoooo",
    },
    {
      image: IMAGE,
      name: "Amelia Doe",
            ...
            {testimonialsData.map((data, i) => (
              <SwiperSlide key={i} className={styles.cb__wrapper}>
                <div className={styles.testi__card}>
                  ...
                  <p className={styles.tc__p}>"{data.testimonial}"</p>
