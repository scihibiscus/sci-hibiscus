  ...
  return (
    <div className={styles.director__word}>
      <div className={styles.dw__wrapper}>
        <div className={styles.dw__image} ref={container}>
          <motion.div style={{ y }} className={styles.dwimg}>
            <Image
              fill
              quality={100}
              placeholder="blur"
            ...
            <div className={styles.dwc__content}>
              ...
              <div className={styles.wordings}>
                ...
                <div className={styles.position}>
                  <span className={styles.name}>Dr Catherine G. Guiadem epse KAMGANG</span>
