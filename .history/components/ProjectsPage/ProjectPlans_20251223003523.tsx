            ...
            <div className={styles.table}>
              ...
              </div>
              {
                plansData.map((data, i) => (
                  <div key={i} className={`${styles.table__row} ${styles.tr__other}`}>
                    <span className={styles.tr__span2}>{data.appartment}</span>
                    <span className={styles.tr__span2}>{data.room}</span>
                    <span className={styles.tr__span2}>{data.area}</span>
                    <span className={styles.tr__span2}>{data.floor}</span>
                    <span className={styles.tr__span2}>{data.price}</span>
                    <a href={data.href} download className={styles.download}><span>PDF</span> <span></span></a>
                  </div>
                ))
              }
            </div>
