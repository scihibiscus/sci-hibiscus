              ...
              </div>
              {
                plansData.map((data, i) => (
                  <div key={i} className={`${styles.table__row} ${styles.tr__other}`}>
                    <span className={styles.}>{data.appartment}</span>
                    <span className={styles.}>{data.room}</span>
                    <span className={styles.}>{data.area}</span>
                    <span className={styles.}>{data.floor}</span>
                    <span className={styles.}>{data.price}</span>
