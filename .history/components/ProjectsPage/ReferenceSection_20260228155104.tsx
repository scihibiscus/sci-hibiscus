...
const ReferenceSection = () => {
  ...
  const searchParams = useSearchParams(); const handleClick = () => { const params = new URLSearchParams(searchParams.toString()); params.set("ref", "myValue"); // set or update the param router.push(`?${params.toString()}`); // navigate with new query string };
