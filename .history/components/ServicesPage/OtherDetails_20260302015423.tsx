...
const OtherDetails = () => {
  ...
  const detailsData = ["Alimentation solaire de secours ", "Salle de réunion équipée", "Local serveur climatisé", "Cuisine / coin pause fonctionnel", "Contrôle d’accès et sécurité"];
  return (
      ...
      <div className={`container ${styles.pa__container2}`}>
        ...
        <div className={styles.details}>
          {detailsData.map((data, i) => (
            <p className={styles.dw__right} key={i}>{data}</p>
          ))}
        </div>
