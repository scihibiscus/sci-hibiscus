...
const PropertyDetails = (  const { t, i18n } = useTranslation();
    ...
    <div className={`section ${styles.pa__section}`}>
      <div className={`container ${styles.pa__container2}`}>
        ...
        <div className={styles.details}>
          ...
          <div className={styles.details__wrap}>
            <p className={styles.dw__left}>
              <span className={styles.dw__inner}>{t("ServicesPage:location")}</span>
            </p>
            <p className={styles.dw__right}>{property.quarter}, {property.city.cityname}</p>
          </div>
