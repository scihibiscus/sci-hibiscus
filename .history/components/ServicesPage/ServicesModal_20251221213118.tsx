...
const ServicesModal = ({ content }: { content: ContentInterface, lenis: Lenis | null }) => {
    ...
    <div className={styles.services__modal}>
      ...
      <div className={styles.sm__right}>
        {content.modals.map((data, i) => (
          <Accordion content={data} key={i} index={i} activeAccordion={activeAccordion} setActiveAccordion={setActiveAccordion} />
        ))}
      </div>
    </div>
  );
