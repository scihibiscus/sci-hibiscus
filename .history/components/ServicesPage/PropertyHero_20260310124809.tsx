            ...
            <div className={styles.hsc__left}>
              ...
              <div className={styles.prop__charac}>
                {property.transaction && (
                  <span className={styles.type}>{currentLocale==="en" ? property.transaction.nameen : property.transaction.namefr}</span>
                )}
                {property.propertytype && <span>{currentLocale==="en" ? property.propertytype.nameen : property.propertytype.namefr}</span>}
                {keyData.rooms && (
                  <span>
