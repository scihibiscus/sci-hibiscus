...
const ServicesPageWrapper = () => {
  ...
  const mainContent = [
    {
      image: IMAGE,
      smallText: t("ServicesPage:current"),
      largeText: t("ServicesPage:devinsale"),
      linkName: t("ServicesPage:herocta"),
      linkHref:
        currentLocale === "en"
    ...
    {
      image: IMAGE2,
      smallText: t("ServicesPage:reserve"),
      largeText: t("ServicesPage:planning"),
      linkName: t("ServicesPage:inplanning"),
      linkHref:
        currentLocale === "en"
