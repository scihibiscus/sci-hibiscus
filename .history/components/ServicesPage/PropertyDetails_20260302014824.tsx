  ...
  return (
    <div className={`section ${styles.pa__section}`}>
      <div className={`container ${styles.pa__container2}`}>
        ...
        <div>
          <WhatsappButton property="Bureau du Park" backColor="white" textColor="var(--black)" border="1px solid rgba(0,0,0,0.)" dropshadow="drop-shadow(0px 0px 5px rgba(0,0,0,0.15))"/>
        </div>
      </div>
    </div>
  );
