...
const Accordion = ({ content,   index,
  activeAccordion,
  setActiveAccordion }: { content: ContentInt, activeAccordion: number;
    setActiveAccordion: React.Dispatch<React.SetStateAction<number>>, index: number }) => {
  //Translations
