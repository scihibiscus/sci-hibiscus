...
const PropertyDisplay = () => {
  ...
  const [selectedSort, setSelectedSort] = use
      ...
      <div className={`container ${styles.rb__container}`}>
        <div className={styles.filter__sort}>
          ...
          <div className={styles.sort__wrapper}>
            ...
            <div className={`${styles.sorting__box} ${activeSort ? styles.active__box : ""}`}>
              <div className={styles.sorter} id="price__asc" onClick={() => setActiveSort(false)}>
                <span className={styles.f__icon}>
                  <Ascending />
                </span>
              ...
              <div className={styles.sorter} id="price__des" onClick={() => setActiveSort(false)}>
                <span className={styles.f__icon}>
                  <Descending />
                </span>
                <span className={styles.f__name}>
              ...
              <div className={styles.sorter} id="area__asc" onClick={() => setActiveSort(false)}>
                <span className={styles.f__icon}>
                  <Ascending />
                </span>
                <span className={styles.f__name}>
              ...
              <div className={styles.sorter} id="area__des" onClick={() => setActiveSort(false)}>
                <span className={styles.f__icon}>
                  <Descending />
                </span>
                <span className={styles.f__name}>
