    ...
    <Link className={styles.property__card} href="/">
      ...
      <div className={styles.property__bottom}>
        ...
        <div className={styles.p__stats}>
          ...
          {data.keyData.rooms && <span>{data.keyData.rooms} {t("Ser")}</span>}
          {data.keyData.bath && <span>{data.keyData.bath} {t("Ser")}</span>}
          {data.keyData.living && <span>{data.keyData.living} {t("Ser")}</span>}
          {data.keyData.area && <span>{data.keyData.area} {t("Ser")}</span>}
        </div>
      </div>
    </Link>
  );
