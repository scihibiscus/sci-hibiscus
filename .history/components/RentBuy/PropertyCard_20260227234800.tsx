    ...
    <Link className={styles.property__card} href="/">
      ...
      <div className={styles.property__bottom}>
        ...
        <div className={styles.p__stats}>
          ...
          {data.keyData.bath && <span>{data.keyData.bath} {t("ServicesPage:room")}</span>}
          {data.keyData.living && <span>{data.keyData.living} {t("ServicesPage:room")}</span>}
          {data.keyData.area && <span>{data.keyData.area} {t("ServicesPage:room")}</span>}
        </div>
      </div>
    </Link>
  );
