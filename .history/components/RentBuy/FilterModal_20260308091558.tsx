...
const FilterModal = ({
  ...
  const priceFilter = {
    ...
    paramKey: "price",
    filters: [
      { id: 1, value: "0-300000", name: "<300k" },
      { id: 2, value: "300000-500000", name: "300k - 500k" },
      { id: 3, value: "500000-1000000", name: "500k - 1M" },
      { id: 4, value: "1000000-10000000", name: "1M - 10M" },
      { id: 5, value: "10000000+", name: "10M>" },
    ],
  };
