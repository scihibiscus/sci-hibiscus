    ...
    <Link className={styles.property__card} href="/">
      ...
      <div className={styles.property__bottom}>
        ...
        <div className={styles.p__stats}>
          ...
          {data.keyData.rooms && <span>{data.keyData.rooms} {t("Se"}</span>}
          {data.keyData.bath && <span>{data.keyData.bath} {t("Se"}</span>}
          {data.keyData.living && <span>{data.keyData.living} {t("Se"}</span>}
          {data.keyData.area && <span>{data.keyData.area} {t("Se"}</span>}
        </div>
      </div>
    </Link>
  );
