    ...
    <Link className={styles.property__card} href="/">
      ...
      <div className={styles.property__bottom}>
        ...
        <div className={styles.p__stats}>
          ...
          {data.keyData.rooms && <span>{data.keyData.rooms} {t("ServicesPage:")}</span>}
          {data.keyData.bath && <span>{data.keyData.bath} {t("ServicesPage:")}</span>}
          {data.keyData.living && <span>{data.keyData.living} {t("ServicesPage:")}</span>}
          {data.keyData.area && <span>{data.keyData.area} {t("ServicesPage:")}</span>}
        </div>
      </div>
    </Link>
  );
