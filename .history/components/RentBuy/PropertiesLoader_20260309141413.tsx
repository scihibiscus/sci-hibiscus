        ...
        <div className={styles.property__card} key={i}>
          ...
          <div className={styles.property__bottom}>
            <span className={styles.p__name2}>
              <SkeletonLoader width="100%" height="40px" mobileHeight="32px" tabletHeight="35px" />
            </span>
            <div className={styles.price__location2}>
              <SkeletonLoader width="100%" height="25px" mobileHeight="18px" tabletHeight="35px" />
            </div>
            <div className={styles.p__stats2}>
              <SkeletonLoader width="100%" height="30px" mobileHeight="22px" tabletHeight="35px" />
            </div>
          </div>
        </div>
      ))}
