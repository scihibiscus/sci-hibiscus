...
const FilterModal = ({
  ...
  return (
    <MotionPathHelper.div className={styles.filter__modal}>
      <div className={styles.modal__content}>
        <div className={styles.modal__container}>
          <div className={styles.modal__top}>
            <span className={styles.m__name}>{t("ServicesPage:filter")}</span>
            <span className={styles.modal__cancel} onClick={() => setActiveModal(false)}>
              <Plus />
            </span>
          </div>
        </div>
        ...
        <div className={styles.applyfilter}>
          <div className={styles.modal__container2}>
            <button className={styles.af__button} onClick={() => setActiveModal(false)}>
