...
const PropertyCard = ({ data }: { data: PropertyProps }) => {
  ...
  //   data.status === "Rent"
  //     ? currentLocale === "en"
  //       ? "/en/service/for-rent/bureau-du-park"
  //       : "/fr/service/a-louer/bureau-du-park"
  //     : data.status === "Buy"
  //     ? currentLocale === "en"
  //       ? "/en/service/for-sale/bureau-du-park"
  //       : "/fr/service/a-vendre/bureau-du-park"
  //     : `${currentLocale}/service`; // fallback

  return (
    <Link className={styles.property__card} href={`/${currentLocale}/services/bureau`}>
      <div className={styles.property__top}>
        <div className={styles.p__image}>
          <Image placeholder="blur" fill quality={100} src={data.image} alt={data.name} />
        </div>
      </div>
