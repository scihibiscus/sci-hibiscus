...
import NotFoundProp from "./NotFoundProp";
        ...
        <div className={`container ${styles.rb__container}`}>
          ...
          <div className={styles.properties}>
            {loading ? (
              ...
              <NotFoundProp message={buildPrefilledMessage()}/>
            ) : (
