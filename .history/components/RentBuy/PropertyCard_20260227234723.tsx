    ...
    <Link className={styles.property__card} href="/">
      ...
      <div className={styles.property__bottom}>
        ...
        <div className={styles.p__stats}>
          ...
          {data.keyData.rooms && <span>{data.keyData.rooms} {t()}</span>}
          {data.keyData.bath && <span>{data.keyData.bath} {t()}</span>}
          {data.keyData.living && <span>{data.keyData.living} {t()}</span>}
          {data.keyData.area && <span>{data.keyData.area} {t()}</span>}
        </div>
      </div>
    </Link>
  );
