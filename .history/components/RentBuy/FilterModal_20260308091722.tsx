...
const FilterModal = ({
  ...
  const surfaceFilter: FilterGroup = {
    name: t("ServicesPage:aream2"),
    paramKey: "area",
    filters: [
      { id: 1, value: "0-100", name: "<100" },
      { id: 2, value: "100-300", name: "100 - 300" },
      { id: 3, value: "300-500", name: "300 - 500" },
      { id: 4, value: "500-1000", name: "500 - 1000" },
      { id: 5, value: "1000+", name: "1000>" },
    ],
  };
  return (
    <motion.div
