          ...
          <div className={styles.navcontent}>
            ...
            <div className={styles.navc__right}>
              <LanguageSelector
                ...
                backColor={
                  activeSideBar ? activeSideColors.backColor : navbackColor
                }
                hoverColor={
                  activeSideBar ? activeSideColors.hoverColor : navhoverColor
                }
                textColor={
                  activeSideBar ? activeSideColors.textColor : navtextColor
                }
                thColor={activeSideBar ? activeSideColors.thColor : navthColor}
              />
              <Link
