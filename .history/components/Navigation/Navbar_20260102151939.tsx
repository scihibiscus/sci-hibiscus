...
const Navbar = ({
  ...
  const barStyle = {
    "--background": activeSideBar ? activeSideColors.backColor : navbarTheme.backColor,
    "--backhover": activeSideBar ? activeSideColors.hoverColor : navbarTheme.hoverColor,
    "--color": activeSideBar ? activeSideColors.textColor : navbarTheme.textColor,
    "--colorhover": activeSideBar ? activeSideColors.thColor : navbarTheme.thColor,
    "--linkcolor": activeSideBar ? activeSideColors.linkColor : navbarTheme.linkColor,
    "--linkhover": activeSideBar ? activeSideColors.lhColor : navbarTheme.lhColor,
    "--logocolor": activeSideBar ? activeSideColors.logoColor : navbarTheme.logoColor,
