            ...
            <div className={styles.fmr__one}>
              {linksDataOne.map((data, i) =>
                data.links ? (
                  ...
                  <Link href={data.link} key={i} className=className={`${styles.text__large} ${styles.textl__link}`}>
                    {data.name}
                  </Link>
                )
              )}
            ...
            <div className={styles.fmr__one}>
              {linksDataTwo.map((data, i) =>
                data.links ? (
                  ...
                  <Link href={data.link} key={i} className={`${styles.text__large} ${styles.textl__link}`}>
                    {data.name}
                  </Link>
                )
              )}
