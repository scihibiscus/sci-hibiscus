        ...
        <div className={styles.footer__mid}>
          <div className={styles.fm__left}>
            ...
            <div className={styles.fml__bottom}>
              <Link href="mailto:sci_hibiscus@ymail.com" className={styles.fm__links}>sci_hibiscus@ymail.com</Link>
              <Link href="tel:222222437" className={styles.fm__links}>+237 2 22 22 24 37</Link>
            </div>
          </div>
