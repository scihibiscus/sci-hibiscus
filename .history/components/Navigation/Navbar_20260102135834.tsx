  ...
  return (
    <>
        ...
        <div className={`container ${styles.nav__container}`}>
          ...
          <div className={styles.navcontent}>
            ...
            <div className={styles.navc__right}>
              ...
              >
                <span className={styles.men}>{activeSideBar ?  t("Navigation:close") : "Menu"}</span>
                <div className={`${styles.menu__lines} ${activeSideBar ? styles.active__side : ""}`}>
      ...
      <AnimatePresence mode="wait">
        {activeQuestion && <SideQuestionnaire setActiveQuestion={setActiveQuestion} activeQuestion={activeQuestion}/>}
      </AnimatePresence>
      <SideBar />
    </>
  );
