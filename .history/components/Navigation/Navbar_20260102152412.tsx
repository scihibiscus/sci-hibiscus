          ...
          <div className={styles.navcontent}>
            ...
            <div className={styles.navc__right}>
              <LanguageSelector
                ...
                backColor={
                  activeSideBar ? activeSideColors.backColor : navbarTheme.backColor
                }
                hoverColor={
                  activeSideBar ? activeSideColors.hoverColor : navbarTheme.hoverColor
                }
                textColor={
                  activeSideBar ? activeSideColors.textColor : navbarTheme.textColor
                }
                thColor={activeSideBar ? activeSideColors.thColor : navbarTheme.thColor}
              />
              <Link
