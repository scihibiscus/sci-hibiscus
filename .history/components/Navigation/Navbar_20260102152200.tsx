      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (self.scroll() < 600) {
            ...
            setNavbarTheme({
              backColor: activeSideColorsbackColor,
              hoverColor: activeSideColorshoverColor,
              textColor: activeSideColorstextColor,
              thColor: activeSideColorsthColor,
              linkColor: activeSideColorslinkColor,
              lhColor: activeSideColorslhColor,
              logoColor: activeSideColorslogoColor,
            });
