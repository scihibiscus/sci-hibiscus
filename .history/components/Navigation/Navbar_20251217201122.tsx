        ...
        <div className={`container ${styles.nav__container}`}>
          ...
          <div className={styles.navcontent}>
            <nav className={styles.navc__left}>
              {navLinks.map((data, i) => (
                <li key={i}>
                  <Link href={data.link} className={styles.nav__links}>{data.name}</Link>
                </li>
              ))}
            </nav>
            <div className={styles.navc__right}>
              <LanguageSelector setLocalState={setLocalState} backColor='white' hoverColor='var(--gold)' textColor='var(--black)' thColor='white'/>
