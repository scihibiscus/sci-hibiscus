...
const Footer = ({ ref }: { ref: RefObject<HTMLDivElement | null> }) => {
  ...
  const linksDataTwo = [
    ...
    },
    {
      ...
      link:
        currentLocale === "en" ? "/en/offer-land" : "/fr/offrir-terrain",
    },
    {
    ...
    },
    {
      ...
      link:
        currentLocale === "en" ? "/en/privacy-policy" : "/fr/confidentialite",
    },
  ];
      ...
      links: [
        {
          ...
          link: currentLocale === "en" ? "/en/services/for-rent" : "/fr/services/a-louer",
        },
        {
          name: t("Navigation:forsale"),
          link: currentLocale === "en" ? "/en/services/for-sale" : "/fr/services/a-vendre",
        },
      ],
    },
    {
  ...
  return (
    <footer className={styles.footer__section}>
      <div className={`container ${styles.footer__container}`}>
        ...
        <div className={styles.footer__bottom} ref={ref}>
          <div className={styles.newsletter}>
            <div className={styles.nl__left}>
