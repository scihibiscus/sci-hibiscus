...
import Angle2 from "@/utils/Icons/Angle2";
    ...
    <>
      <header className={styles.navigation} style={barStyle} ref={Navbar}>
        <div className={`container ${styles.nav__container}`}>
          <Link href="/" className={styles.wordmark} prefetch={true}>
            <WordmarkLogo />
          </Link>
          <div className={styles.navcontent}>
            <nav className={styles.navc__left}>
              {navLinks.map((data, i) => (
                ...
                >
                  ...
                  {data.moreData && (
                    <span className={styles.angle__icon}>
                      <Angle2 />
                    </span>
                  )}
                  {data.moreData && (
                    <div className={styles.service__modal}>
                      {data.moreData.map((content, i) => (
                        <Link
                          href={content.link}
            ...
            <div className={styles.navc__right}>
              <LanguageSelector
                ...
                thColor={
                  activeSideBar ? activeSideColors.thColor : navbarTheme.thColor
                }
              />
              <Link
