  ...
  return (
    <>
          ...
          <div className={styles.navcontent}>
            ...
            <div className={styles.navc__right}>
              <LanguageSelector
                ...
                backColor={activeSideBar ? activeSideColors.backColor : backColor}
                hoverColor={activeSideBar ? activeSideColors.hoverColor : hoverColor}
                textColor={activeSideBar ? activeSideColors.textColor :textColor}
                thColor={activeSideBar ? activeSideColors.backColor :thColor}
              />
              <Link
      ...
      <AnimatePresence mode="wait">
        {activeSideBar && <SideBar activeSideBar={activeSideBar} />}
      </AnimatePresence>
    </>
  );
};
